...
// vevent var
var vevent = function(dtstart, dtend, summary, description, location)
{
...
veventParser.prototype.vevent = function(input)
{
	...
	if(this.check("BEGIN", input))
	{
		...
		var p = new iCal(args.dtstart, args.dtend, args.summary, args.description, args.location, []);
		this.note(input, p);
		this.expect("BEGIN",input);
...
veventParser.prototype.body = function(input)
{
	...
	return { dtstart: dtstart, dtend: dtend, summary: summary, description: description, location: location };
}
